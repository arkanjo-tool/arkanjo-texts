...
%% Takeaway Boxes - ACM Compatible %%
\usepackage{framed}
\newenvironment{highlight-box}[1]{%
  \begin{framed}%
  \noindent\textbf{#1:} \itshape\ignorespaces}{%
  \end{framed}}

%% DRY Highlight Box - ACM Compatible %%
...
\citet{harderSoftwareClonesGuilty2017} acknowledges the harmful case of cloned bugs, but provides empirical evidence for beneficial cases as well; concluding the thesis without clear advice for practitioners, and an open path for new research, like this one.
