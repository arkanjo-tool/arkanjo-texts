...
%TODO: precisamos fazer um gancho, para sinalizar que a partir do que observamos no T1, vimos a necessidade de investigar a visão dos mantenedores a partir de outros patches relacionados a redução de duplicação...
