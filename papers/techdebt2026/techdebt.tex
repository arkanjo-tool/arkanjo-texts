...
\affiliation{
  \institution{Free Software Competence Center, Institute of Mathematics, Statistics, and Computer Science, Universidade de São Paulo}
  \country{Brazil}
}
\email{{marcelomspessoto,luanicaro,davidbtadokoro}@usp.br; rpassos,paulormm\}@ime.usp.br}
