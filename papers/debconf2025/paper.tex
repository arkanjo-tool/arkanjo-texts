...
designed to detect and analyze function-level duplications. Released under the GNU Lesser General Public License (LGPL), ArKanjo employs a two-stage architecture consisting of a Preprocessor and 
...
help developers identify code clone duplication at the function level. Released under
LGPLv3 (GNU Lesser General Public License, version 3), ArKanjo is available at 
