...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{explorer_example}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{function_example}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{relatory_example}
...
A discrepancy emerges when detecting non-duplicate pairs between
