...
\todo[inline]{Require an introduction about IIO drivers.}

\todo[inline]{Not exactly on this section, but I need to mention GIT, as one of the similarity methods is based on the GIT command.}
