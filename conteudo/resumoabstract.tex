...
O kernel Linux é um projeto de código aberto amplamente utilizado, alimentando 3,77\% 
dos desktops pessoais e 70,69\% dos smartphones em todo o mundo. Dada a sua extensa 
...
orientações para futuros contribuintes.

}

\abstract{

The Linux kernel is a widely used open-source project, powering 3.77\% of personal desktops 
and 70.69\% of smartphones worldwide. Given its extensive user base, any addition of features, 
