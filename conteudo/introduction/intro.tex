...
kernel subsystems, focuding our study on the AMD Display Driver and the Industril IO subsytem. 
Our approach includes the development of a tool capable of detecting
...
expect this tool to effectively detect code duplications in the targeted subsytems of the Linux kernel,
...
identifying code duplications within the context of the Linux kernel subsytems studied. 
We then
