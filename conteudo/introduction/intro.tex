...
such as refactoring methods commonly used to address code duplications. These
patterns will serve as a guide for future contributors in mitigating code
duplication issues within this context. To investigate our approach, we use the
initial version of our tool to identify duplicate code in the Linux kernel,
specifically targeting parts of the AMD Display driver code. We will then
refactor portions of this code and submit patches to maintainers, providing
evidence of the tool's accuracy in detecting duplicate functions.

Our research design follows a multi-method approach, utilizing various
methodologies to answer our research questions. We have structured the study
into two phases, each employing different research methods.
