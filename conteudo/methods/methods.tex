...
\todo[inline]{Remove comment to align the items and fix the line size if breaks}
\begin{itemize}
...
Of the students who chose to work on the ArKanjo-related tasks, 26 (19 undergraduate and 7 graduate) 
