...
and describes the ethnographic methodology for engaging with the Linux community. Firstly, 
...
From the students enrolled in the in the course, 25 students opted for the first alternative and 1 student
...
On a second stage of the Free Software Development course, we propose to students to contribute directly 
with the ArKanjo tool development without help from the tool creator, to verify if the tool can be a 
free software where multiple people can contribute. The tool's issue approached by the students where 
of our knowledge our pointed to us in the survey feedback. A total of three students forming two groups 
worked in direct contributions, a not a very expressive number compared with the initiate experiment.
