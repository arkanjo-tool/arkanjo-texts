...
% packages to format the text like the papers
\usepackage{seqsplit}
...
\banca{
  Prof. Dr. Paulo Meirelles (Advisor) -- IME-USP,
  Prof. Dr. Gregorio Robles -- URJC,
  Prof. Dr. Antonio Soares de Azevedo Terceiro -- Linario,
}
...
\noindent Arcanjo, Luan Ícaro Pinto

An approach for detecting and mitigating code duplication in the Linux Kernel / Luan Ícaro Pinto Arcanjo; orientador, Paulo Meirelles. - São Paulo, 2025.
...
1. SOFTWARE LIVRE. 2. KERNEL LINUX. 3. DUPLICAÇÃO DE CÓDIGO. 4. REFATORAÇÃO. 5. MANUTENÇÃO DE SOFTWARE. I. Meirelles, Paulo. II. Título.
...
\epigrafe{If you don't take risks, you can't create a future}{Monkey D. Luffy}

I want to sincerely thank my advisor, Paulo Meireless, for all his help and 
guidance throughout my master’s program and research. I am also deeply grateful 
to Rodrigo Siqueira for his critical help, from suggesting how to apply software 
engineering techniques to the Linux kernel to being our essential point of contact 
with the AMD Display driver team, which made the experiments in this work possible. 
My thanks go to my colleagues David Tadokoro and Marcelo Spessoto for our valuable 
collaborations on papers.
I must also thank all the students who accepted the challenge to mitigate code 
duplication found by the ArKanjo tool. Finally, a huge thank you to my family 
and friends for their support along the way.
...
\begin{tabular}{rl}
   ...
   IIO & Industrial Input Output - An Linux subsystem\\
\end{tabular}
